      ...
      >
        {current ? (
          <div className="h-[102px] w-[102px] relative">
            ...
            >
              <Button
                ...
                className="h-[70px] w-[70px] border-b-8 cursor-pointer flex items-center justify-center p-0"
              >
                <Icon
                  className={cn(
          ...
          <Button
            size="rounded"
            variant={locked ? "locked" : "secondary"}
            className="h-[70px] w-[70px] border-b-0 flex items-center justify-center p-0"
          >
            <Icon
              className={cn(
                "w-10 h-10 md:w-12 md:h-12",
